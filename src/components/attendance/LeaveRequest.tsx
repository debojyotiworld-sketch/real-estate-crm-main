...
interface LeaveRequestProps {
  ...
  pendingLeaves: Record<string, any>[];
  approvedLeaves: Record<string, any>[];
  rejectedLeaves: Record<string, any>[];
}
  ...
  return (
    <div className="rounded-2xl border bg-card p-6">
      ...
      <ProfessionalDialog
        ...
        description="Check leave details carefully."
